...
def tune_weights_ms(train_test_sets, sets_model_selection,
    ...
    for i in np.arange(0, len(train_test_sets), 4): # i.e. for each sliding window
        ...
        weight_vector = {
            'optimal_weights_sw'+str(list(sets_model_selection.keys())[i])[8] : \
